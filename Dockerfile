...
COPY Platformify_Cookies_App Platformify_Cookies_App
COPY assets assets
...
COPY --from=builder --chown=sid:sid /app/Platformify_Cookies_App/static /app/Platformify_Cookies_App/static
COPY requirements requirements
